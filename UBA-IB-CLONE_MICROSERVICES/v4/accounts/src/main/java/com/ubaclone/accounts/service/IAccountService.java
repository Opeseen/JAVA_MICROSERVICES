...
public interface IAccountService {
  ...
  void createAdditionalAccountForCustomer(AccountDTO accountDTO);
  AccountInformationDTO fetchAccountInformation(Long accountNumber); // returns customer and account info
  List<AccountInformationDTO> fetchAllCustomerAccount(String email);
  Account findByAccountNumber(Long accountNumber); // returns account info
  String verifyUserAccount(Long accountNumber); // verify if account exists
}
