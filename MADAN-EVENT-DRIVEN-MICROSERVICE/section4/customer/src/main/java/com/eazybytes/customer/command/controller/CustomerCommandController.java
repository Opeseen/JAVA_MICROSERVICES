...
public class CustomerCommandController {
  ...
  private final CommandGateway commandGateway; // routes command to the right handler
  ...
  public ResponseEntity<ResponseDto> updateCustomerDetails(@Valid @RequestBody CustomerDto customerDto) {
    UpdateCustomerCommand updateCustomerCommand = UpdateCustomerCommand
        .builder()
  ...
  public ResponseEntity<ResponseDto> deleteCustomer(@RequestParam("customerId")
    ...
    DeleteCustomerCommand deleteCustomerCommand = DeleteCustomerCommand
        .builder()
